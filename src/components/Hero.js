      ...
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <p className="-m-1.5 p-1.5 font-semibold">Niyati</p>
          </div>
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    A Software Developer based in India, specializing in technical education through hands-on learning and application development.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <button className="btn btn-outline btn-square">
                    <a href="https://www.linkedin.com/in/niyati-nehal-5791221b6/">
                    <svg
                  ...
                  <button className="btn btn-outline btn-square">
                    <a href="https://github.com/niyatinehal">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-8 w-8"
                      fill="currentColor"
